# -*- coding: utf-8 -*-
"""
Created on Wed Dec 10 15:09:00 2025
...
with exp1:
    st.markdown('<div class="card"><div class="card-title">Export</div></div>', unsafe_allow_html=True)
    csv = f.to_csv(index=False).encode("utf-8")
    st.download_button(
        "Download filtered data (CSV)",
        data=csv,
        file_name="filtered_validations.csv",
        mime="text/csv",
    )
